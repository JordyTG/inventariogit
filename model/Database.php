...
class Database {
    ...
    private static $dbName = 'inventariotfsbdd';
    private static $dbHost = 'inventariotfs.mysql.database.azure.com';
    private static $dbUsername = 'JordyTG@inventariotfs';
    private static $dbUserPassword = 'admin.1234';
    private static $port = '3306';
    //Propiedad para control de la conxeion:
    ...
    public static function connect() {
        ...
        if (null == self::$conexion) {
            try {
                self::$conexion = new PDO("mysql:host=" . self::$dbHost . ";" ."port=" . self::$port. ";" . "dbname=" . self::$dbName, self::$dbUsername, self::$dbUserPassword);
